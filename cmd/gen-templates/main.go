...
var sheets = []sheet{
		...
		rows: [][]any{
			{
				...
				3,
				"UD Maju",
				"https://contoh.com/gambar/beras.jpg",
			},
	...
	},
	{
		...
		rows: [][]any{
			{
				"Panel Harga Badan Pangan",
				"Harga pangan harian nasional",
				"https://panelharga.badanpangan.go.id",
				"harga",
			},
			{
				"PIHPS Bank Indonesia",
				"Harga pangan strategis antarwilayah",
				"https://www.bi.go.id/hargapangan",
				"harga",
			},
			{"Kemendag SP2KP/EWS", "Harga & pasokan bahan pokok nasional", "https://ews.kemendag.go.id", "harga"},
			{
				"Distan & Ketahanan Pangan NTT",
				"Harga komoditi pasar Kupang (mingguan)",
				"https://distankp.nttprov.go.id",
				"harga",
			},
