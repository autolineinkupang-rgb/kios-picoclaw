...
// store_access.go — data-access methods for *Store and package-level helpers,
// split out of store.go to keep each file under the 500-line project limit.
// Type definitions, Redis key constants, and KiosConfig remain in store.go.
