...
func (t *PromoTool) Parameters() map[string]any {
	return map[string]any{
		...
		"properties": map[string]any{
			...
			"produk":     map[string]any{"type": "string", "description": "nama/id produk (buat: produk yang dipromo; cek: produk yang dicek diskonnya)"},
			...
			"qty":        map[string]any{"type": "integer", "description": "jumlah beli pembeli saat ini (cek) — dicocokkan ke min_qty promo"},
			...
			"catatan":    map[string]any{"type": "string", "description": "catatan bebas tentang promo"},
