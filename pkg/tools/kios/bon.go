	...
	return map[string]any{
		...
		"properties": map[string]any{
			"action": map[string]any{
				"type": "string",
				"enum": []string{
					"jual_bon", "catat_hutang_supplier", "bayar", "lunasi",
					"hapus", "daftar_piutang", "daftar_hutang", "detail",
				},
				"description": "Aksi bon/piutang. jual_bon: jual kredit ke pembeli; catat_hutang_supplier: catat hutang kios ke supplier; bayar/lunasi: cicil/lunasi; daftar_*: list; detail: rincian by id.",
			},
			"produk":       map[string]any{"type": "string", "description": "nama/id produk yang dijual (jual_bon)"},
			"qty":          map[string]any{"type": "integer", "description": "jumlah unit (jual_bon)"},
			"pelanggan":    map[string]any{"type": "string", "description": "nomor WA atau nama pelanggan (jual_bon)"},
			"id":           map[string]any{"type": "string", "description": "id piutang/hutang: PIU-xxxx atau HUT-xxxx (bayar/lunasi/hapus/detail)"},
			"jumlah":       map[string]any{"type": "integer", "description": "nominal pembayaran yang diterima, rupiah (bayar/lunasi)"},
			"metode":       map[string]any{"type": "string", "enum": []string{"tunai", "transfer", "qris"}, "description": "metode pembayaran (bayar/lunasi), default tunai"},
			"supplier_id":  map[string]any{"type": "string", "description": "id supplier SUP-xxxx yang dihutangi (catat_hutang_supplier)"},
			"pembelian_id": map[string]any{"type": "string", "description": "id pembelian terkait PEM-xxxx (opsional, catat_hutang_supplier)"},
			"pokok":        map[string]any{"type": "integer", "description": "total hutang pokok ke supplier, rupiah (catat_hutang_supplier)"},
			"filter":       map[string]any{"type": "string", "description": "filter tampil: nomor WA pembeli atau supplier_id (daftar_piutang/daftar_hutang)"},
			"jatuh_tempo":  map[string]any{"type": "string", "description": "tanggal jatuh tempo YYYY-MM-DD (catat_hutang_supplier)"},
			"catatan":      map[string]any{"type": "string", "description": "catatan bebas"},
		},
