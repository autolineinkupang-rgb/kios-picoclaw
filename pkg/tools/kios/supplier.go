...
func (t *SupplierTool) Parameters() map[string]any {
	return map[string]any{
		...
		"properties": map[string]any{
			...
			"kontak":       map[string]any{"type": "string", "description": "nomor telepon/WA supplier"},
			"alamat":       map[string]any{"type": "string", "description": "alamat supplier"},
			"produk_utama": map[string]any{"type": "string", "description": "jenis/kategori produk utama yang disuplai (bukan id produk)"},
			"pic":          map[string]any{"type": "string", "description": "nama PIC/sales"},
			"catatan":      map[string]any{"type": "string", "description": "catatan bebas tentang supplier"},
