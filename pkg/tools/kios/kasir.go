...
func (t *KasirTool) Parameters() map[string]any {
	return map[string]any{
		...
		"properties": map[string]any{
			...
			"produk": map[string]any{"type": "string", "description": "nama atau id produk yang dijual"},
			"qty":    map[string]any{"type": "integer", "description": "jumlah unit yang dijual"},
			"items": map[string]any{
				"type":        "array",
				"description": "daftar item untuk jual_massal (metode bayar diambil dari parameter 'metode' di atas, bukan per-item)",
				"items": map[string]any{
					"type": "object",
					"properties": map[string]any{
						"produk": map[string]any{"type": "string", "description": "nama atau id produk"},
						"qty":    map[string]any{"type": "integer", "description": "jumlah unit"},
					},
				},
			},
			"metode":      map[string]any{"type": "string", "enum": []string{"tunai", "transfer", "qris", "bon"}, "description": "metode bayar; bon = kredit/piutang pembeli"},
